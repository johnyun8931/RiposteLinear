...
export INGESTION_QUEUE_BACKEND INGESTION_S3_BUCKET INGESTION_RECEIVE_BATCH_SIZE INGESTION_SQS_WAIT_SECONDS INGESTION_SQS_VISIBILITY_TIMEOUT_SECONDS INGESTION_WORKER_ERROR_BACKOFF_MS SERVER_INGESTION_IAM_POLICY_NAME
