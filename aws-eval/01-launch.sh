...
export SHARD0_STANDBY_LEADER_PORT SHARD0_STANDBY_FOLLOWER_PORT SHARD1_STANDBY_LEADER_PORT SHARD1_STANDBY_FOLLOWER_PORT
...
export CLOUDWATCH_OBSERVABILITY CLOUDWATCH_LOG_RETENTION_DAYS
...
payload = {
    ...
    "shard0_standby_leader_port": os.environ["SHARD0_STANDBY_LEADER_PORT"],
    "shard0_standby_follower_port": os.environ["SHARD0_STANDBY_FOLLOWER_PORT"],
    "shard1_standby_leader_port": os.environ["SHARD1_STANDBY_LEADER_PORT"],
    "shard1_standby_follower_port": os.environ["SHARD1_STANDBY_FOLLOWER_PORT"],
    ...
    "cloudwatch_observability": os.environ["CLOUDWATCH_OBSERVABILITY"],
    "cloudwatch_log_retention_days": int(os.environ["CLOUDWATCH_LOG_RETENTION_DAYS"]),
}
